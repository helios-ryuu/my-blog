...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      tiltEngine.cancel();
      shell.classList.remove("entering");
      wrapEl?.style.setProperty("--card-opacity", "0");
    };
  }, [
    enableTilt,
    enableMobileTilt,
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            {/* User Info & Contact Action Bar */}
            {showUserInfo && (
              <div
                className="absolute z-20 flex items-center justify-between border border-white/20 shadow-2xl pointer-events-auto transition-transform duration-200"
                style={{
                  bottom: "20px",
                  left: "20px",
                  right: "20px",
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start gap-1">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-white/80 leading-none">
                ...
                <button
                  className="border border-white/20 rounded-lg px-4 py-2.5 text-xs font-semibold text-white bg-white/10 hover:bg-white/20 hover:border-white/40 cursor-pointer backdrop-blur-md transition-all duration-200 ease-out hover:-translate-y-px active:translate-y-0 shadow-sm"
