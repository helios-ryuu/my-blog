        ...
        <div ref={dropdownRef} className="relative">
            ...
            {isOpen && (
                <div className="absolute right-0 top-full z-50 mt-2 w-48 rounded-md border border-(--border-color) bg-background py-1 shadow-lg">
                    ...
                    <button type="button" onClick={handleLogout} className="flex w-full cursor-pointer items-center gap-2 px-3 py-2 text-sm text-red-500 transition-colors hover:bg-red-500/10">
